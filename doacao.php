...
<body>
  <nav class="navbar navbar-expand-lg position-fixed top-0">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="./assets/img/logo medio.png" alt=""></a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="./dashboard.html">Inicio</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./registroDoacao.html">Minhas Doações</a>
          </li>
    ...
    <form action="?" method="POST" class="card px-4 py-4">
        ...
        <select class="form-select rounded-5 mb-3" id="inputDoacao">
            ...
            <option value="mantimentos">Matimentos</option>
            <option value="dinheiro">Dinheiro</option>
        </select>
        <div class="mb-3 d-flex gap-3">
            <div>
                <input placeholder="Quantidade" type="number" min="1" class="form-control rounded-5"
                    id="inputQuantidade" disabled>
            </div>
            <div>
                <input placeholder="Valor" type="text" class="form-control rounded-5" id="inputValor" disabled>
            </div>
        </div>
        <button type="submit" class="btn btn-lg btn-primario rounded-5 mt-3">Doar</button>
